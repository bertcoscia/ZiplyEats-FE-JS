  ...
  return (
    <Container className="signup my-5 pt-5 align-items-center">
      <div className="signup__options d-flex flex-column flex-lg-row justify-content-between align-items-center">
        <Link to={"/signup/user"} className="signup__element perfect-shadow border rounded-4 align-self-center py-4 px-5 text-decoration-none position-relative my-3 bg-primary text-text" as={Button} style={{ overflow: "visible" }}>
          <img
        ...
        <Link to={"/signup/rider"} className="signup__element perfect-shadow border rounded-4 align-self-center py-4 px-5 text-decoration-none position-relative my-3 bg-primary text-text" as={Button} style={{ overflow: "visible" }}>
          <img
            className="signup__element__illustration position-absolute top-0 start-50 translate-middle mb-5"
        ...
        <Link to={"/signup/restaurant"} className="signup__element perfect-shadow border rounded-4 align-self-center py-4 px-5 text-decoration-none position-relative my-3 bg-primary text-text" as={Button} style={{ overflow: "visible" }}>
          <img
            className="signup__element__illustration position-absolute top-0 start-50 translate-middle mb-5"
