...
const RestaurantDashboardComponent = () => {
  return (
    <>
      <Container className="dashboard mt-5 d-flex flex-column flex-lg-row justify-content-around" style={{ paddingTop: "140px" }}>
        <Link as={Button} to={"/past-orders"} className="dashboard__element text-decoration-none border rounded-4 pt-4 pb-1 px-5 position-relative align-self-center mb-5 mb-lg-0 bg-primary text-text" style={{ overflow: "visible" }}>
          <img
        ...
        <Link as={Button} to={"/edit-menu"} className="dashboard__element text-decoration-none border rounded-4 pt-4 pb-1 px-5 position-relative align-self-center mt-5 mt-lg-0 bg-primary text-text" style={{ overflow: "visible" }}>
          <img
            className="dashboard__element__illustration position-absolute top-0 start-50 translate-middle"
